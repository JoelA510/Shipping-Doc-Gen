-- AlterTable
ALTER TABLE "Party" ADD COLUMN "lat" REAL;
ALTER TABLE "Party" ADD COLUMN "lng" REAL;
...
CREATE TABLE "new_Comment" (
    ...
    CONSTRAINT "Comment_shipmentId_fkey" FOREIGN KEY ("shipmentId") REFERENCES "Shipment" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_Comment" ("createdAt", "documentId", "id", "text", "userId") SELECT "createdAt", "documentId", "id", "text", "userId" FROM "Comment";
DROP TABLE "Comment";
ALTER TABLE "new_Comment" RENAME TO "Comment";
CREATE INDEX "Comment_userId_idx" ON "Comment"("userId");
CREATE INDEX "Comment_documentId_idx" ON "Comment"("documentId");
CREATE INDEX "Comment_shipmentId_idx" ON "Comment"("shipmentId");
